...
<template>
    <Head title="Privacy Policy - Rajan Crackers">
        <meta name="description" content="Privacy Policy of Rajan Crackers. Learn how we collect, use, and protect your personal information when you order crackers from our website." />
    </Head>
        ...
        <div class="mx-auto max-w-3xl px-4 py-8">
            ...
            <div class="prose prose-sm max-w-none text-brand-gray prose-headings:font-heading prose-headings:text-brand-dark prose-h3:text-lg prose-h3:font-semibold prose-a:text-brand-red">
                ...
                <p>
                    ...
                    Email: mjkkalirajan880@gmail.com<br>
